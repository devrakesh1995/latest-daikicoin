...
// import ReceivSendCoin from '../pages/SendCoin/ReceivSendCoin';
    ...
    return (
      <>{isLoading ?
        ...
        <SafeAreaProvider>
          <NavigationContainer>
            {!isLoggedIn ?
              <RouteStack.Navigator headerMode='none' initialRouteName="introSlider">
                <RouteStack.Screen name='SelectionScreen' component={introSlider} />
                <RouteStack.Screen name='initialSelectionscreen' component={initialSelectionscreen} />
                ...
                <RouteStack.Screen name="Transaction" component={Transaction} />
